...
// VARIABLES GLOBALES //dia 23_9_11
extern UINT8 rssiWIWI[2];
//
...
BOOL MACGetHeader(MAC_ADDR *remote, BYTE* type)
{
	...
	//DIA 23_9_11
	#define RAW_RX_RSSI_INDEX (2) //REVISAR WFDataTxRx.c
	RawRead(RAW_RX_ID, RAW_RX_RSSI_INDEX, 2, (UINT8 *) rssiWIWI);
...
//DIA 23_9_11
//	#define RAW_RX_RSSI_INDEX (2) //REVISAR WFDataTxRx.c
//	RawRead(RAW_RX_ID, RAW_RX_RSSI_INDEX, 2, rssiWIWI);
//END DIA 23_9_11
