...
/****************************************************************************
  ...
  Remarks:
    None
  ***************************************************************************/
void Delay10us_MiWi( UINT32 tenMicroSecondCounter )//FERNANDO, DUPLICIDAD
{
...
/****************************************************************************
  ...
  Remarks:
    None
  ***************************************************************************/
void DelayMs_MiWi( UINT16 ms )//FERNANDO, DUPLICIDAD
{
    #if defined(__18CXX)
        ...
        while (ms--)
        {
            ...
            while (i--)
            {
                Delay10us_MiWi( 25 );//FERNANDO, DUPLICIDAD
            }
        }
    #endif
}
