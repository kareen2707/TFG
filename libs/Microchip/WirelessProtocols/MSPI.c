...
void SPIPut(BYTE v)
{
    BYTE i;
        ...
        SPI_SDO = 0; 
            ...
            SpiChnPutC(SPI_CHANNEL3A,v);//putcSPI1(v);//FERNANDO
            i = SpiChnGetC(SPI_CHANNEL3A);//i = (BYTE)getcSPI1();//FERNANDO
        #else
            IFS0bits.SPI1IF = 0;
            i = SPI1BUF;
            SPI1BUF = v;
...
BYTE SPIGet(void)
{
        ...
        return spidata;
            ...
            SpiChnPutC(SPI_CHANNEL3A,0x00);//putcSPI1(0x00);//FERNANDO
            dummy = (BYTE)SpiChnGetC(SPI_CHANNEL3A);//dummy = (BYTE)getcSPI1();//FERNANDO
            return(dummy);
        #else
            SPIPut(0x00);
            return SPI1BUF;
