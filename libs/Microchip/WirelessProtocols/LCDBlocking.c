...
#define SAMSUNG_S6A0032		// This LCD driver chip has a different means of entering 4-bit mode.  
     ...
     * Note:            None
     *****************************************************************************/
    static void LCDWrite(BYTE RS, BYTE Data) //FERNANDO
    {
...
//    	memset(LCDText, ' ', 32);
    ...
    void LCDWriteLine(WORD number, char *line) //FERNANDO
    {
//        BYTE    i;
//        BYTE    j;
//    
