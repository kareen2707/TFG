...
*******************************************************************************/
    ...
    #include "WirelessProtocols/ConfigApp.h"
        ...
        /**********************************************************************/
        // ENABLE_DUMP will enable the stack to be able to print out the content
        // of the P2P connection entry. It is useful in the debugging process
        /**********************************************************************/
        #define ENABLE_DUMP
        ...
        // timeout, the RFD device can continue to operate and then go to sleep
        // to conserve battery power.
        /**********************************************************************/
        #define RFD_DATA_WAIT                   0x00003FFF
        
        /**********************************************************************/
        // CONNECTION_RETRY_TIMES is the maximum time that the wireless node can
        // try to establish a connection. Once the retry times are exhausted
        ...
        // interval, which can be longer than OPEN_SOCKET_TIMEOUT, the solution
        // is to poll the data at a fast rate, lower than OPEN_SOCKET_TIMEOUT.
        // OPEN_SOCKET_POLL_INTERVAL is the polling interval in symbols for a
        // sleeping device to acquire data from its parent in the process of
        // establishing indirect (socket) connection. This parameter is only
        // valid for sleeping device.
        /**********************************************************************/
        #define OPEN_SOCKET_POLL_INTERVAL       (ONE_SECOND)
            
        /**********************************************************************/
        // ENABLE_MIWI_ACKNOWLEDGEMENT enables the MiWi stack to acknowledge the
        // data packet from the application layer.
        /**********************************************************************/
        //#define ENABLE_MIWI_ACKNOWLEDGEMENT

        /**********************************************************************/
        // MIWI_ACK_TIMEOUT is the timeout period in symbols for a node to
        // receive a MiWi network layer acknowledgement. This parameter is for
        ...
        // track the broadcast messages so that the wireless node knows if the
        // same broadcast has been received before.
        /**********************************************************************/
        #define BROADCAST_RECORD_SIZE   4
        
        /**********************************************************************/
        // BROADCAST_RECORD_TIMEOUT defines the timeout in symbols for a node to
        // expire its broadcast record. The broadcast record is used to track
        // the received broadcast message and to prevent receiving duplicate
        // broadcast message. This definition is only valid for a non-sleeping
        // device.
        /**********************************************************************/
        #define BROADCAST_RECORD_TIMEOUT    (ONE_SECOND)
        
        /**********************************************************************/
        // When broadcasting to a sleeping device is enabled, it is hard for a
        // parent node to track which end device has received the broadcast
        ...
        // coordinators before such route is disabled in the decision of message
        // route. Proper definition of this parameter helps to update the
        // available routes dynamically. This definition is only valid for a
        // coordinator.
        /*********************************************************************/
        ...
        /**********************************************************************/
        // INDIRECT_MESSAGE_SIZE defines the maximum number of packets that the
        // device can store for the sleeping device(s)
        /**********************************************************************/
        #define INDIRECT_MESSAGE_SIZE   2
    
        /**********************************************************************/
        // INDIRECT_MESSAGE_TIMEOUT defines the timeout interval in seconds for
        // the stored packets for sleeping devices
        /**********************************************************************/
        #define INDIRECT_MESSAGE_TIMEOUT (ONE_SECOND * RFD_WAKEUP_INTERVAL * \
                                          INDIRECT_MESSAGE_TIMEOUT_CYCLE)
    
        /**********************************************************************/
        // FA_BROADCAST_TIME defines the total number of times to broadcast the
        // channel hopping message to the rest of PAN, before the Frequency
        // Agility initiator jump to the new channel
        /**********************************************************************/
        ...
        // feature of P2P stack. It combines the message that is send from the
        // sleeping device with Data Request command upon wakeup, to save 20% -
        // 30% active time for sleeping device, thus prolong the battery life.
        /**********************************************************************/
        ...
        // connected to the FFD, so that each sleeping device can be assigned to
        // a time slot. The time slot period is calcualted by following formula:
        ...
        /**********************************************************************/
        // COUNTER_CRYSTAL_FREQ defines the frequency of the crystal that is
        // connected to the MCU counter to perform timing functionality when MCU
        // is in sleep.
        /**********************************************************************/
