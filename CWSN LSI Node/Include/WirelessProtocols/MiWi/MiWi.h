/*******************************************************************************
* FileName:	MiWi.h                  SLIGHTLY MODIFIED FROM ORIGINAL STACK!!!
...
void SendIndirectPacket(BYTE *Address, BYTE *AltAddress, BOOL isAltAddress, miwi_band mb);
BYTE AddNodeToNetworkTable(miwi_band mb);
void DiscoverNodeByEUI(miwi_band mb);
...
/*******************************************************************************
 * Overview: The structure to store indirect messages for devices turn off radio
 * when idle
 ******************************************************************************/
typedef struct{
...
//Juan: I define this structure to gather all the temporal node's information
//received from a single radio interface or use some of it internally.
typedef struct{
    CONNECTION_STATUS status;
    WORD_VAL PANID;
    WORD_VAL shortAddr;
    BYTE longAddr[MY_ADDRESS_LENGTH];
} TEMP_NODE_INFO;
...
/****************************** EXTERNAL VARIABLES ****************************/
    ...
    extern MIWI_STATE_MACHINE MRF24J40_MiWiStateMachine;
#endif
#if defined MRF49XA_1
    extern BYTE MRF49XA_1_TxBuffer[];
    extern BYTE MRF49XA_1_TxData;
    extern MIWI_STATE_MACHINE MRF49XA_1_MiWiStateMachine;
#endif
#if defined MRF49XA_2
    extern BYTE MRF49XA_2_TxBuffer[];
    extern BYTE MRF49XA_2_TxData;
    extern MIWI_STATE_MACHINE MRF49XA_2_MiWiStateMachine;
#endif

#if defined MIWI_0434_RI
    extern WORD_VAL myPAN0434ID;
    extern WORD_VAL myShort0434Addr;
    extern BYTE my0434Parent;
    extern TEMP_NODE_INFO temp0434;
    extern OPEN_SOCKET Socket0434Info;
#endif
#if defined MIWI_0868_RI
    extern WORD_VAL myPAN0868ID;
    extern WORD_VAL myShort0868Addr;
    extern BYTE my0868Parent;
    extern TEMP_NODE_INFO temp0868;
    extern OPEN_SOCKET Socket0868Info;
#endif
#if defined MIWI_2400_RI
    extern WORD_VAL myPAN2400ID;
    extern WORD_VAL myShort2400Addr;
    extern BYTE my2400Parent;
    extern TEMP_NODE_INFO temp2400;
    extern OPEN_SOCKET Socket2400Info;
#endif
