...
/************************ DEFINITIONS ******************************/
    ...
    #define MY_PB_DIVIDER   4
    //Juan: INSTR_FREQ asume que el divisor del Peripheral bus es 4... modificar
    //con el valor adecuado. Echar un vistazo al SymbolTime de willy.
    #define INSTR_FREQ  20000000    //pongo el valor a pincho porque se vuelve loco.
                                    //Es la frecuencia de reloj entre el PB_DIV
        ...
        #define SYMBOL_TO_TICK_RATE INSTR_FREQ
    #endif
    #define TICKS_PER_SECOND (INSTR_FREQ/CLOCK_DIVIDER)

    #define ONE_SECOND (((DWORD)INSTR_FREQ/1000 * TICKS_PER_SECOND) / (SYMBOL_TO_TICK_RATE / 1000))
    /* SYMBOLS_TO_TICKS to only be used with input (a) as a constant, otherwise you will blow up the code */
