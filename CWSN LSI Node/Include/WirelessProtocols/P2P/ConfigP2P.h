...
*******************************************************************************/
    ...
    #include "WirelessProtocols/ConfigApp.h"
        ...
        /**********************************************************************/
        #define RFD_DATA_WAIT                   0x0003FFFF
        ...
        /**********************************************************************/
        // ACTIVE_SCAN_RESULT_SIZE defines the maximum active scan result that
        // the stack can hold. If active scan responses received exceed the
        // definition of ACTIVE_SCAN_RESULT_SIZE, those later active scan
        ...
        // sleeping device with Data Request command upon wakeup, to save
