/*******************************************************************************
* FileName:	MSPI.h                   SLIGHTLY MODIFIED FROM ORIGINAL STACK!!
* Dependencies: none
...
********************************************************************************
* File Description: This file provides the interface to the SPI
*
* Change History:
...
/**************************** FUNCTION PROTOTYPES *****************************/
//Microchip LSI Node: Original functions adapted for using up to 4 SPI modules
void SPIPut(UINT8 mod, BYTE v);
BYTE SPIGet(UINT8 mod);

//Microchip LSI Node: Functions added for debugging.
