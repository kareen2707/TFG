...
#include "Transceivers/Transceivers.h"
    ...
    BYTE tmpBlock[BLOCK_SIZE];
        ...
        #endif
            //SWSecurityKey defined for MRF49XAs and MRF89XA transceivers, as the key size
            //can be different from MRF24J40's (IEEE 802.15.4) key size.
            ROM const unsigned char mySWSecurityKey[8] = {SECURITY_KEY_00, SECURITY_KEY_01, SECURITY_KEY_02,    // The 16-byte security key used in the
